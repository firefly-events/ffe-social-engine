...
Linear: https://linear.app/firefly-events/issue/FIR-1187
...
With only 5 Pro users, the dedicated inference hardware is fully paid for, allowing for significant scaling of voice/video generation with minimal additional marginal cost until hardware capacity (estimated at several hundred concurrent users, pending load testing) is reached.
