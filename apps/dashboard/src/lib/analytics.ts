...
export const ANALYTICS_EVENTS = {
  ...
  // CTA Tracking
  CREATE_POST_CLICK: SE_EVENTS.CREATE_POST_CLICK,
  QUICK_ACTION_CLICK: SE_EVENTS.QUICK_ACTION_CLICK,
  VIEW_ALL_ACTIVITY_CLICK: SE_EVENTS.VIEW_ALL_ACTIVITY_CLICK,
  UPGRADE_PLAN_CLICK: SE_EVENTS.UPGRADE_PLAN_CLICK,
  HERO_CTA_CLICK: SE_EVENTS.HERO_CTA_CLICK,
  PRICING_CTA_CLICK: SE_EVENTS.PRICING_CTA_CLICK,
  SIGNUP_CTA_CLICK: SE_EVENTS.SIGNUP_CTA_CLICK,
  CHAT_MESSAGE_SENT: SE_EVENTS.CHAT_MESSAGE_SENT,

  // Voice
  VOICE_CLONE_CREATED: SE_EVENTS.VOICE_CLONE_CREATED,
  VOICE_SPEECH_GENERATED: SE_EVENTS.VOICE_SPEECH_GENERATED,
  VOICE_CLONE_DELETED: SE_EVENTS.VOICE_CLONE_DELETED,
} as const
